...
public class ObjectDetectingActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private
    ObjectDetector mLowerBodyDetector;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        objectDetectingView.setOnOpenCVLoadListener(new OnOpenCVLoadListener() {
            ...
            public void onOpenCVLoadSuccess() {
                ...
                mFaceDetector = new ObjectDetector(getApplicationContext(), R.raw.lbpcascade_frontalface,
                        6, 0.2F,
                        0.2F, new Scalar(255, 0, 0, 255));
                mEyeDetector = new ObjectDetector(getApplicationContext(), R.raw.haarcascade_eye,
                        6, 0.1F,
                        0.1F, new Scalar(0, 255, 0, 255));
                ...
                mFullBodyDetector = new ObjectDetector(getApplicationContext(),
                        R.raw.haarcascade_fullbody, 3, 0.3F,
                        0.5F, new Scalar(255, 0, 255, 255));
                mSmileDetector = new ObjectDetector(getApplicationContext(),
                        R.raw.haarcascade_smile, 10, 0.2F,
                        0.2F, new Scalar(0, 255, 255, 255));
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            ...
            case R.id.rb_smile:
                if (isChecked) {
                    Toast.makeText(getApplicationContext(), "Smile test", Toast.LENGTH_SHORT).show();
